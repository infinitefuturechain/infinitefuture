...
`infinitefuturecli` 需要通过操作系统的终端窗口使用，打开步骤如下所示： 
...
Infinitefuture地址是一个以可读词开头的字符串(比如`if10snjt8dmpr5my0h76xj48ty80uzwhraqalu4eg`) 如果有人想给你转账通证，他们就往这个地址转账。根据给定地址来推算私钥是不可行的。
