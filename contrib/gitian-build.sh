...
DEFAULT_GAIA_SIGS=${GAIA_SIGS:-'infinitefuture.sigs'}
DEFAULT_GITIAN_REPO='https://github.com/devrandom/gitian-builder'
DEFAULT_GBUILD_FLAGS=''
DEFAULT_SIGS_REPO='https://github.com/infinitefuturechain/infinitefuture.sigs'
...
f_build() {
  ...
  bin/gbuild --commit infinitefuture="$g_commit" ${GBUILD_FLAGS} "$l_descriptor"
