...
func TestInfinitefutureCLIKeysAddMultisig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIMinimumFees(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start infinitefutured server with minimum fees
...
func TestInfinitefutureCLIGasPrices(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIFeesDeduction(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLISend(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIGasAuto(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLICreateValidator(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIQueryRewards(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	cdc := app.MakeCodec()
	...
	genFile := filepath.Join(f.InfinitefuturedHome, "config", "genesis.json")
...
func TestInfinitefutureCLIQuerySupply(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLISubmitProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	proposalsQuery = f.QueryGovProposals("--limit=10") // Joe.He
	require.Equal(t, uint64(2), proposalsQuery[0].ProposalID)

	f.Cleanup()
}

func TestInfinitefutureCLISubmitParamChangeProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLISubmitCommunityPoolSpendProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIQueryTxPagination(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIValidateSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLISendGenerateSignAndBroadcast(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIMultisignInsufficientCosigners(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIEncode(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIMultisignSortSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIMultisign(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestInfinitefutureCLIConfig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	config, err := ioutil.ReadFile(path.Join(f.InfinitefuturecliHome, "config", "config.toml"))
	require.NoError(t, err)
...
func TestInfinitefuturedCollectGentxs(t *testing.T) {
	t.Parallel()
...
func TestInfinitefuturedAddGenesisAccount(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
