...
import (
	...
	infinitefuture "github.com/infinitefuturechain/infinitefuture/app"
)
...
func runHackCmd(cmd *cobra.Command, args []string) error {
	...
	db, err := sdk.NewLevelDB("infinitefuture", dataDir)
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
	app, keyMain, keyStaking, stakingKeeper := infinitefuture.NewInfinitefutureAppUNSAFE(
	...
	// XXX: start hacking!
	//----------------------------------------------------
	// eg. infinitefuture-6001 testnet bug
